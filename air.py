...
#def load_data():
 ...
 #   return pd.read_csv("C:/Users/ASUS 502/OneDrive/Desktop/a.py/Airbnb.csv")
#data=load_data
...
def datafr():
    df= pd.read_csv("C:/Users/ASUS 502/OneDrive/Desktop/a.py/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    st.write('''***Airbnb Vacation rental company :blue[airbnb.co.in]
    ...
    with col1:
        image1=Image.open("C:/Users/Asus 502/OneDrive/Desktop/a.py/phone-airbnb-logo-key-house-chain-swansea-uk-march-app-displayed-smartphone-home-keyring-yellow-back.jpg")
        st.image(image1)
    ...
    #st.write('''The objective of this project is to analyze Airbnb data comprehensively. This analysis includes exploring pricing dynamics, availability patterns, location-based insights, and geospatial visualization. Through these analyses, the project aims to provide valuable insights into Airbnb's market trends, helping stakeholders make informed decisions regarding accommodation, pricing strategies, and investment opportunities.''')
    #st.write('''In real time,we can take property investor.He want to buy homes.This analysis helps informer to make informed decisions,ensuring their properties are priced competitively and based on location where demand is high they increase the rental income''')
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/ASUS 502/OneDrive/Desktop/a.py/Airbnb.csv")
            return df_a
